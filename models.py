...
class EuroAll(Base):
    ...
    id = Column('id', UUID(as_uuid=True), Sequence("euro_all_seq"), primary_key=True, default=uuid.uuid4, unique=True, nullable=False)
...
class WinResults(Base):
    ...
    id = Column('id', UUID(as_uuid=True), Sequence("win_results_seq"), primary_key=True, default=uuid.uuid4, unique=True, nullable=False)
    # game_date_id = Column(Integer, ForeignKey('euro_game_day.id'))
    game_date_id = Column(UUID(as_uuid=True), ForeignKey('euro_game_day.id'))
...
class EuroStarNumbers(Base):
    ...
    id = Column('id', UUID(as_uuid=True), Sequence("euro_star_numbers_seq"), primary_key=True, default=uuid.uuid4, unique=True, nullable=False)
    # game_date_id = Column(Integer, ForeignKey('euro_game_day.id'))
    game_date_id = Column(UUID(as_uuid=True), ForeignKey('euro_game_day.id'))
