...
class Config:
    # database options
    ALCHEMICAL_DATABASE_URL = constants.EXTERNAL_SQLALCHEMY_DATABASE_URI or 'sqlite:///' + os.path.join(basedir, 'db.sqlite')
    ...
    PASSWORD_RESET_URL = os.environ.get('PASSWORD_RESET_URL') or 'http://localhost:3000/reset'
    USE_CORS = as_bool(os.environ.get('USE_CORS') or 'yes')
    CORS_SUPPORTS_CREDENTIALS = True

    # API documentation
    APIFAIRY_TITLE = 'Million API'
